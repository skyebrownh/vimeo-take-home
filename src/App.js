  ...
  return (
    <main>
      <section className="monsoon">
        ...
        <img src="https://i.vimeocdn.com/video/595198868_505x160.jpg" alt="Monsoon III Image"/>
      </section>
      <section className="beams">
        ...
        <img src="https://i.vimeocdn.com/video/589972810_530x315.jpg" alt="Beams Image"/>
        <div className="move2">
          <h2>Move 2</h2>
        ...
        <img src="https://i.vimeocdn.com/video/595198868_505x160.jpg" alt="Move 2 Image"/>
      </section>
